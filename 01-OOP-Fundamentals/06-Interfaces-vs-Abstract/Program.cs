//Key Decision Criteria: Interfaces vs Abstract Classes
//When to Use Interfaces:

//Multiple inheritance needed - A class can implement many interfaces
//Pure contracts - Define WHAT something can do, not HOW
//Completely different implementations - Email vs SMS vs Push notifications
//Capability-based design - ILoggable, ICacheable, IConfigurable
//Dependency injection scenarios - Clean contracts for DI containers

//When to Use Abstract Classes:

//Shared implementation - Common behavior across related classes
//IS-A relationships - Car IS-A Vehicle, Truck IS-A Vehicle
//Template method pattern - Define algorithm structure, let subclasses fill in details
//Constructor requirements - Need to initialize common state
//Protected members - Share implementation details with subclasses

//Quick Decision Framework
//When you're designing a system, ask yourself these questions:
//1. Do I need multiple inheritance?

//Yes → Interface
//No → Could be either

//2. Do I have shared implementation/behavior?

//Yes → Abstract class (with interfaces for contracts)
//No → Interface

//3. Is this an IS-A relationship?

//Yes → Abstract class
//No → Interface

//4. Am I defining what something can DO vs what something IS?

//CAN DO → Interface (IPayable, ILoggable, ICacheable)
//WHAT IT IS → Abstract class (Vehicle, Employee, Document)

//Advanced Benefits for Senior Engineers
//Dependency Injection: Interfaces are perfect for DI containers - you register the interface and inject implementations.
//Testing: Interfaces make unit testing trivial with mocking frameworks or simple mock implementations.
//Plugin Architecture: Define interfaces for plugin contracts, let different assemblies implement them.
//Configuration-Based Switching: Use configuration to determine which implementation to inject at runtime.
//API Design: Public APIs should expose interfaces, hide concrete implementations.
//The Bottom Line
//Use both together for maximum power:

//Abstract classes for shared behavior in inheritance hierarchies
//Interfaces for contracts, capabilities, and dependency injection
//Combine them when you need both inheritance AND multiple capabilities
